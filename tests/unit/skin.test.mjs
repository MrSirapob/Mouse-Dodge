...
import { ParticleSystem } from '../../js/rendering/particles.js?v=20260824-7uzh';
import { SKIN_BY_ID } from '../../js/data/skins.js?v=20260824-7uzh';
...
export async function run() {
  ...
  await s.testAsync('constructor: P2 starts on the default skin even before any reset() call', async () => {
    ...
    const { Game } = await import('../../js/systems/game.js?v=20260824-7uzh');
