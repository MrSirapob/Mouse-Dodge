...
import { ParticleSystem } from '../../js/rendering/particles.js?v=20260829-zc1d';
import { SKIN_BY_ID } from '../../js/data/skins.js?v=20260829-zc1d';
...
export async function run() {
  ...
  await s.testAsync('constructor: P2 starts on the default skin even before any reset() call', async () => {
    ...
    const { Game } = await import('../../js/systems/game.js?v=20260829-zc1d');
